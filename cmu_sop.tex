...
My neuroscience work has largely focused on developing segmentation models for dendrites \customcommand{freseg}{D}, synaptic vesicles \customcommand{hydra,hydra_bio,xiaomeng}{A,B,F}, and cerebral vasculature \customcommand{freseg,trisam}{D,E}. Presently, my research spans three projects: enhancing the PyTorch Connectomics framework using segmentation-guided contrastive learning foundation models, clustering neurons in fresh-water polyps \customcommand{hydra_bio}{B} using translation and rotation equivariant autoencoders \customcommand{hydra}{A}, and adapting cell tracking solutions to extract whole-brain neural dynamics in roundworms \customcommand{wormnd}{C}.

Going forward, I hope to study how machine learning can be leveraged to better understand cognition while also investigating neuro-inspired architectures. \textbf{Prof.\ Aran Nayebi’s} paper on scaling laws for models that predict the neural activity of the \textit{C.\ elegans} roundworm highlights the need for more data. My ongoing work directly addresses this concern---last summer, I began developing benchmarks for neural activity trace extraction from calcium imaging to promote progress in high-throughput data collection \customcommand{wormnd}{C}. I am interested in continuing this line of research in developing an \textit{in silico} model of the nematode’s nervous system.

Due to my recent project involving transformers \customcommand{trisam}{E}, \textbf{Prof.\ Leila Wehbe’s} recent work on understanding the human visual cortex using vision foundation models is particularly interesting to me. I am keen on exploring how fMRI data can uncover the mechanisms behind human thought and its applications for clinical diagnoses. I would also be open to work on statistical techniques to characterize neural circuits with \textbf{Prof.\ Robert Kass}.

I am applying to the CMU Rales Fellows Program, NSF Graduate Research Fellowship Program, DOD National Defense Science and Engineering Graduate Fellowship Program, DOE Computational Science Graduate Fellowship, Paul \& Daisy Soros Fellowships for New Americans, and Graduate Fellowships for STEM Diversity to seek additional funding.

I believe that my interdisciplinary background, spanning vision foundation models, imaging modalities, and biomedical applications, has uniquely prepared me to contribute to rigorous research at Carnegie Mellon.
