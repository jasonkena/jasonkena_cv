...
Since Fall 2023, I have been \textbf{remotely advising high school students} at Sekolah Pelita Harapan in Tangerang, Indonesia through the \textbf{Applied Science Academy}. This year, I have the pleasure of working with a sophomore interested in autonomous vehicles. It was through the same program that I found my passion for computer vision, and I am humbled to now support his growth in robotics. Months ago, we brainstormed the idea of building a remote-controlled car with a mounted camera to create spatial navigation maps using neural radiance fields. Last week, he set up a Flask server on a Raspberry Pi to control the car’s motors, and he is now working on feeding the camera footage into Nerfstudio.
...
Pursuing a PhD in Computer Science at UCLA would be a step in that direction. I look forward to taking advantage of the service opportunities available at UCLA. Whether by mentoring high school students through the \textbf{Los Angeles Computing Circle}, or being a TA for \textbf{“EE149: Foundations of Computer Vision,”} I hope to inspire.
