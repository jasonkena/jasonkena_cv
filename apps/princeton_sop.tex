...
All in all, my experience includes developing segmentation models for dendrites \customcommand{freseg}{D}, synaptic vesicles \customcommand{xiaomeng}{F}, blood vessels \customcommand{freseg,trisam}{D,E}, rib cages \customcommand{ribseg}{H}, and heart structures \customcommand{imheart}{G}. This work spans electron microscopy, fluorescence microscopy, CT, and MRI imagery, utilizing voxel, point cloud, and neural field representations. I am currently working on three projects: enhancing the PyTorch Connectomics framework using segmentation-guided contrastive learning foundation models, clustering neurons in fresh-water polyps using translation and rotation equivariant autoencoders \customcommand{hydra,hydra_bio}{A,B}, and adapting cell tracking solutions to extract whole-brain neural dynamics in roundworms \customcommand{wormnd}{C}.

Going forward, I aim to apply computer vision techniques to new domains and broaden my research scope. I am intrigued by \textbf{Prof.\ Ellen Zhong's} work on cryo-EM, where methods like neural fields and diffusion models are used to reconstruct complex geometries from noisy images. I am also considering expanding beyond medical imaging by collaborating with \textbf{Prof.\ Jia Deng} to study procedural generation and inverse rendering in natural imagery. Additionally, I am intrigued by \textbf{Prof.\ Felix Heide's} research on computational imaging, which leverages machine learning to improve raw sensor fidelity.

Finally, although \textbf{Prof.\ Sebastian Seung's} lab has shifted its focus from image analysis, I would be open to exploring how insights on neural circuitry can be extracted from reconstructed connectomes.

I believe that my interdisciplinary background, spanning diverse geometric representations, imaging modalities, and biomedical applications, has uniquely prepared me to contribute to rigorous research at Princeton.
