...
\textbf{Neuroscience} research has led me to develop segmentation models for dendrites \customcommand{freseg}{D}, synaptic vesicles \customcommand{hydra,hydra_bio,xiaomeng}{A,B,F}, and cerebral vasculature \customcommand{freseg,trisam}{D,E}. Last summer, I expanded on this work by developing benchmarks for neural activity trace extraction from calcium imaging \customcommand{wormnd}{C}, aiming to advance efforts in reverse-engineering the \textit{C.\ elegans} nervous system. Going forward, I hope to study how machine learning can be leveraged to better understand cognition while also investigating neuro-inspired architectures. I am drawn to \textbf{Prof.\ Konrad Kording’s} line of research on the nematode’s connectome and methods for neural decoding. I am also keen on exploring the connection between deep neural networks and brain activity through fMRI under the guidance of \textbf{Prof.\ Jianbo Shi}.

Central to all my past work has been \textbf{computer vision}. I have extensive experience training point cloud architectures to process dendrites in 3D microscopy \customcommand{freseg}{D} and rib cage structures in CT scans \customcommand{ribseg}{H}, which aligns with Prof.\ Shi’s efforts in point cloud analysis. In terms of equivariance, my projects have involved using E(2) equivariant autoencoders to cluster vesicles in \textit{Hydra vulgaris} neurons \customcommand{hydra,hydra_bio}{A,B} and adapting the Frenet-Serret formulas to induce invariance to deformations in anatomical structures \customcommand{freseg}{D}. I would be open on studying how geometric priors can empower data-efficient models under \textbf{Prof.\ Kostas Daniilidis}.
